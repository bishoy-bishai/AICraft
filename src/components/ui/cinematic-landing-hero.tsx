      ...
      <div className="absolute inset-0 z-20 flex items-center justify-center pointer-events-none" style={{ perspective: "1500px" }}>
        ...
        >
          ...
          <div className="relative w-full h-full max-w-7xl mx-auto px-4 lg:px-12 flex flex-col justify-evenly lg:grid lg:grid-cols-3 items-center lg:gap-8 z-10 py-6 lg:py-0">
            ...
            {/* 2. MIDDLE (Mobile) / CENTER (Desktop): MOCKUP */}
            <div className="mockup-scroll-wrapper order-2 lg:order-2 relative w-full h-[380px] lg:h-[600px] flex items-center justify-center z-10" style={{ perspective: "1000px" }}>
              ...
              <div className="relative w-full h-full flex items-center justify-center transform scale-[0.65] md:scale-85 lg:scale-100">
                ...
                <div
                  ref={mockupRef}
                  className="relative w-[280px] h-[580px] rounded-[3rem] iphone-bezel flex flex-col will-change-transform transform-style-3d border border-white/20"
                >
                  {/* Hardware Buttons */}
                  ...
                  <div className="absolute inset-[7px] bg-[#050f0c] rounded-[2.5rem] overflow-hidden shadow-[inset_0_0_15px_rgba(0,0,0,1)] text-white z-10">
                    ...
                    {/* App Interface */}
                    <div className="relative w-full h-full pt-12 px-5 pb-8 flex flex-col font-mono text-left">
                      <div className="phone-widget flex justify-between items-center mb-6">
                        <div className="flex flex-col">
                          <span className="text-[10px] text-emerald-400/80 uppercase tracking-widest font-bold mb-0.5">Execution</span>
                          <span className="text-lg font-bold tracking-tight text-white drop-shadow-md">7-Phase Loop</span>
                        </div>
                        <div className="w-8 h-8 rounded-full bg-emerald-500/20 text-emerald-300 flex items-center justify-center font-bold text-xs border border-emerald-400/30">
                          AI
                        </div>
                      </div>
                      ...
                      <div className="phone-widget relative w-40 h-40 mx-auto flex items-center justify-center mb-6 drop-shadow-[0_15px_25px_rgba(0,0,0,0.8)]">
                        <svg className="absolute inset-0 w-full h-full" aria-hidden="true">
                          ...
                          <circle className="progress-ring" cx="80" cy="80" r="58" fill="none" stroke="#10b981" strokeWidth="10" />
                        </svg>
                        <div className="text-center z-10 flex flex-col items-center">
                          <span className="counter-val text-3xl font-extrabold tracking-tighter text-white">0</span>
                          <span className="text-[8px] text-emerald-200/60 uppercase tracking-[0.1em] font-bold mt-0.5">{metricLabel}</span>
                        </div>
                      </div>

                      <div className="space-y-2.5">
                        <div className="phone-widget widget-depth rounded-xl p-2.5 flex items-center">
                          <div className="w-8 h-8 rounded-lg bg-emerald-500/20 flex items-center justify-center mr-2.5 border border-emerald-400/30">
                            <span className="text-emerald-400 font-bold text-xs">✓</span>
                          </div>
                          <div className="flex-1 text-[10px]">
                            <div className="text-white font-bold">Understand Gate</div>
                            <div className="text-emerald-300/70">4/4 Prerequisites Passed</div>
                          </div>
                        </div>
                        <div className="phone-widget widget-depth rounded-xl p-2.5 flex items-center">
                          <div className="w-8 h-8 rounded-lg bg-primary/20 flex items-center justify-center mr-2.5 border border-primary/30">
                            <span className="text-primary font-bold text-xs">●</span>
                          </div>
                          <div className="flex-1 text-[10px]">
                            <div className="text-white font-bold">Phase 05: Validate</div>
                            <div className="text-zinc-400">All Tests Verified</div>
                          </div>
                        </div>
                      </div>
                ...
                <div className="floating-badge absolute flex top-6 lg:top-12 left-[-15px] lg:left-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                  ...
                  <div>
                    <p className="text-white text-xs lg:text-sm font-bold tracking-tight">15 Rules Enforced</p>
                    <p className="text-emerald-200/50 text-[10px] lg:text-xs font-medium">Constitution Active</p>
                  </div>
                </div>

                <div className="floating-badge absolute flex bottom-12 lg:bottom-20 right-[-15px] lg:right-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                  <div className="w-8 h-8 lg:w-10 lg:h-10 rounded-full bg-gradient-to-b from-primary/20 to-emerald-900/10 flex items-center justify-center border border-primary/30 shadow-inner">
                    <span className="text-base lg:text-lg drop-shadow-lg" aria-hidden="true">⚡</span>
                  </div>
                  <div>
                    <p className="text-white text-xs lg:text-sm font-bold tracking-tight">Zero Hallucination</p>
                    <p className="text-emerald-200/50 text-[10px] lg:text-xs font-medium">Evidentiary Proof</p>
                  </div>
                </div>
            ...
            <div className="card-left-text gsap-reveal order-3 lg:order-1 flex flex-col justify-center text-center lg:text-left z-20 w-full lg:max-w-none px-4 lg:px-0">
              ...
              <p className="hidden md:block text-emerald-100/70 text-sm md:text-base font-normal leading-relaxed mx-auto lg:mx-0 max-w-sm lg:max-w-none">
                {cardDescription}
              </p>
            </div>
